...
class DiaryActivity : AppCompatActivity() {
    ...
    private fun showMenu() {
        binding.btnMenu.setOnClickListener {
            if (binding.btnMenu.isChecked) {
                binding.menuEdit.setVisible()
            } else {
    ...
    private fun updateDiaryDate() {
        binding.btnEditDate.setOnClickListener {
            ...
            val fragEditDate = EditDateBottomSheetFragment {
                ...
                binding.tvDiaryDate.text = "${it[0]}. ${getMonth(it[1])}. ${getDate(it[2])}. $pickerDay"
    ...
    private fun updateDiaryContent() {
        binding.btnEditDiary.setOnClickListener {
            ...
            intent.putExtra("diary_day", binding.tvDiaryDate.text.toString())
            intent.putExtra("diary_content", binding.tvDiaryContent.text.toString())
