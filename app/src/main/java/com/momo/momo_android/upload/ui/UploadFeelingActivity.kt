...
class UploadFeelingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.hasExtra("diaryStatus")) {
            ...
            when (value) {
                //오늘일기가 있으면 모달이 바로 뜨며 일기 안쓴 가장 최근 일자 가져오기. Picker/tvDate 설정
        ...
        //캘린더 img 클릭시 모달 연결
        binding.imgDate.setOnClickListener { openDateModal() }
    ...
    private fun setDate(no_data_day: String) {
        ...
        binding.tvDate.text = "${upload_year}. ${month}. ${date}. ${day}"
    ...
    private fun setToday() {
        ...
        binding.tvDate.text = "${year}. ${month}. ${date}. ${week}"
